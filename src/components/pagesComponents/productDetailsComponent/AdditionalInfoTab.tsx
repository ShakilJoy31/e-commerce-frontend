...
export default function AdditionalInfoTab({ description }: { description: string }) {
  ...
  const classMap = {
    ...
    td: 'px-4 py-2 text-sm text-gray-700 border border-gray-300', // Added border
    tr: 'hover:bg-gray-50 even:bg-gray-50' // Added zebra striping
  };
