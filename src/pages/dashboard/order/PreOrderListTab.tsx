...
interface PreOrderListTabProps {
  selectedRow: any[];
...
const PreOrderListTab = ({ setSelectedRow, filterBy, categoryId, from, to }: PreOrderListTabProps) => {
  ...
  const type = "All";
  const { data, isLoading, isError } = useGetPreOrdersTabQuery({
...
export default PreOrderListTab;
