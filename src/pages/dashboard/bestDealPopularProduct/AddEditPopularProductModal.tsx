...
const AddEditPopularProductModal: React.FC<AddEditBestDealProductModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  initialData,
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-6 shadow-lg w-1/3">
        <h2 className="text-lg font-semibold mb-4 pl-5">
          {initialData ? "Edit Popular Product" : "Add Popular Product"}
        </h2>
...
export default AddEditPopularProductModal;