...
import { FiEdit, FiMessageSquare, FiSearch, FiTrash2 } from "react-icons/fi";
...
const ProductList = ({ selectedRows, setSelectedRows }: any) => {
        ...
        <div className="flex justify-between items-center bg-white px-4 rounded-t-lg">
          <div className="flex gap-4 items-center my-4">
            ...
            >
              ...
              <option value="SubCategoryChange">SubCategory Change</option>
              <option value="Brand">Brand Change</option>
              <option value="MoveToPublished">Change Type</option>
              <option value="StockStatus">Change Stock-Status</option>
            </select>
          ...
          <div className="space-x-2 py-5">
            {selectOption === "CategoryChange" && (
              <button
                ...
                className="px-4 py-1 rounded border text-blue-500 border-blue-500 hover:bg-blue-50"
                ...
                <td className="px-4 py-2 flex gap-2 items-center">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <MdOutlinePriceChange className="text-[30px] cursor-pointer" />
                    </DialogTrigger>
                    <DialogContent className="p-6 rounded-lg shadow-lg sm:max-w-[1200px] h-[90vh] overflow-y-auto">
                      <UpdateProductPrice product={product?.productLink} />
                    </DialogContent>
                  </Dialog>
                  <a href={`/products/${product?.productLink}`} target="_blank">
                    {" "}
                  ...
                  {/* Reply to Reviews Icon with Link */}
                  <Link to={`/kry-admin-portal/product-list/reply/${product.id}`}>
