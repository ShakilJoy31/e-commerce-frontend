...
const AdminManagement = () => {
  ...
  const { data, isLoading, isError, refetch } = useGetAdminQuery({
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <div className="flex justify-between items-center bg-white px-4 rounded-lg">
          ...
          <div className="space-x-2 py-5">
            ...
            <Link to={"/kry-admin-portal/add-admin-management"}>
              <Button>
                <Plus />
              </Button>
            </Link>
                  ...
                  <td className="px-4 py-2">
                    <DropdownMenu>
                      ...
                      >
                        ...
                        <>
                          <Link
                            to={`/kry-admin-portal/activity-log-admin-manage/${row.id}`}
                          >
                            <Button
                              className="w-full flex justify-start p-1"
                              variant={"outline"}
